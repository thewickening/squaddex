...
st.sidebar.subheader('SquirtleSquadMC')
st.sidebar.write("The Pokemon listed here, are custom Pokemon for the Pixelmon server SquirtleSquadMC")
st.sidebar.write("https://squirtlesquadmc.com")
